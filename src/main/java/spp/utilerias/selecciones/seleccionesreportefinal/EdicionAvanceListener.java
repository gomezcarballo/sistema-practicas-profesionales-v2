 ...
 * @author gomes
 */
public class EdicionAvanceListener implements EventHandler<CellEditEvent<ActividadReporteFinal, String>>{
    
    private TableView<ActividadReporteFinal> tblActividades;

    public EdicionAvanceListener(TableView<ActividadReporteFinal> tblActividades) {
